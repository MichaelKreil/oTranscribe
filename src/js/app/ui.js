...
var keyboardShortcuts = [
        [['escape','alt'], function(){  oT.player.playPause();                         }],
        [['f1','ctrl'],    function(){  oT.player.skip('backwards');                   }],
        [['f2'],           function(){  oT.player.skip('forwards');                    }],
        [['f3'],           function(){  oT.player.speed('down');                       }],
        [['f4'],           function(){  oT.player.speed('up');                         }],
